...
void setup() {
  ...
  myTextlabelA = cp5.addTextlabel("label")
                    .setText("UNE LEGENDE ROUGE")
                    .setPosition(100,50)
                    .setColorValue(0xffff0000)          //0xaarrvvbb (a = alpha)
                    .setFont(createFont("Georgia",20))
                    ;
                    
  // une autre légende : définie comme cela elle doit être explicitement avec Textlabel.draw(myTextLabel).                  
  myTextlabelB = new Textlabel(cp5,"une autre légende",100,100,400,200);
